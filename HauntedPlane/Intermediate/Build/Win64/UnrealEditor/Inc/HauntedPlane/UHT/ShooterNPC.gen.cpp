...
HAUNTEDPLANE_API UClass* Z_Construct_UClass_AShooterNPC();
HAUNTEDPLANE_API UClass* Z_Construct_UClass_AShooterNPC_NoRegister();
HAUNTEDPLANE_API UClass* Z_Construct_UClass_AShooterWeapon_NoRegister();
...
struct Z_Construct_UDelegateFunction_HauntedPlane_PawnDeathDelegate__DelegateSignature_Statics
{
#if WITH_METADATA
...
const UECodeGen_Private::FDelegateFunctionParams Z_Construct_UDelegateFunction_HauntedPlane_PawnDeathDelegate__DelegateSignature_Statics::FuncParams = { { (UObject*(*)())Z_Construct_UPackage__Script_HauntedPlane, nullptr, "PawnDeathDelegate__DelegateSignature", 	nullptr, 
	0, 
0,
RF_Public|RF_Transient|RF_MarkAsNative, (EFunctionFlags)0x00130000, 0, 0, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UDelegateFunction_HauntedPlane_PawnDeathDelegate__DelegateSignature_Statics::Function_MetaDataParams), Z_Construct_UDelegateFunction_HauntedPlane_PawnDeathDelegate__DelegateSignature_Statics::Function_MetaDataParams)},  };
UFunction* Z_Construct_UDelegateFunction_HauntedPlane_PawnDeathDelegate__DelegateSignature()
{
	static UFunction* ReturnFunction = nullptr;
	if (!ReturnFunction)
	{
		UECodeGen_Private::ConstructUDelegateFunction(&ReturnFunction, Z_Construct_UDelegateFunction_HauntedPlane_PawnDeathDelegate__DelegateSignature_Statics::FuncParams);
	}
...
const UECodeGen_Private::FImplementedInterfaceParams Z_Construct_UClass_AShooterNPC_Statics::InterfaceParams[] = {
	{ Z_Construct_UClass_UShooterWeaponHolder_NoRegister, (int32)VTABLE_OFFSET(AShooterNPC, IShooterWeaponHolder), false },  // 823244811
};
...
// ********** Begin Registration *******************************************************************
struct Z_CompiledInDeferFile_FID_Users_xander_Documents_GitHub_haunted_plane_HauntedPlane_Source_HauntedPlane_Variant_Shooter_AI_ShooterNPC_h__Script_HauntedPlane_Statics
{
	static constexpr FClassRegisterCompiledInInfo ClassInfo[] = {
		{ Z_Construct_UClass_AShooterNPC, AShooterNPC::StaticClass, TEXT("AShooterNPC"), &Z_Registration_Info_UClass_AShooterNPC, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(AShooterNPC), 2446548980U) },
	};
}; // Z_CompiledInDeferFile_FID_Users_xander_Documents_GitHub_haunted_plane_HauntedPlane_Source_HauntedPlane_Variant_Shooter_AI_ShooterNPC_h__Script_HauntedPlane_Statics 
static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Users_xander_Documents_GitHub_haunted_plane_HauntedPlane_Source_HauntedPlane_Variant_Shooter_AI_ShooterNPC_h__Script_HauntedPlane_1968125983{
	TEXT("/Script/HauntedPlane"),
	Z_CompiledInDeferFile_FID_Users_xander_Documents_GitHub_haunted_plane_HauntedPlane_Source_HauntedPlane_Variant_Shooter_AI_ShooterNPC_h__Script_HauntedPlane_Statics::ClassInfo, UE_ARRAY_COUNT(Z_CompiledInDeferFile_FID_Users_xander_Documents_GitHub_haunted_plane_HauntedPlane_Source_HauntedPlane_Variant_Shooter_AI_ShooterNPC_h__Script_HauntedPlane_Statics::ClassInfo),
	nullptr, 0,
	nullptr, 0,
};
// ********** End Registration *********************************************************************
